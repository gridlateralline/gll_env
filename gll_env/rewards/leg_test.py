...
def test_factory_builds_the_bundled_tariffs() -> None:
    ...
    for name in ("solarquartier", "fair_leg", "flat_leg"):
...
def test_rebate_split_tariffs_reward_trading_inside_the_community() -> None:
    """The constructed tariffs must make LEG strictly better than VNB on both sides.

    Both are built by waiving part of the grid usage fee and splitting the
